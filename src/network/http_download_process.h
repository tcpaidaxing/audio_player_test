...
typedef enum {
	...
	HTTP_DOWNLOAD_STA_START,
	HTTP_DOWNLOAD_STA_STOP,
...
typedef enum {
    HTTP_DOWNLOAD_EVENT_NONE        = 0x000000UL,
    HTTP_DOWNLOAD_EVENT_ALL         = 0xFFFFFFUL,
    ...
    HTTP_DOWNLOAD_EVENT_EXIT        = 0x000010UL,
    HTTP_DOWNLOAD_EVENT_EXITED      = 0x000020UL,
    HTTP_DOWNLOAD_EVENT_STOPPED     = 0x000040UL,
    HTTP_DOWNLOAD_EVENT_STARTED     = 0x000080UL,
...
typedef struct {
	http_download_status_t      cur_state;
